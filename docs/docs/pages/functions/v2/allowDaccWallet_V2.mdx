# allowDaccWallet_V2 [A function Allow a Wallet access and Private key V2]
...
```ts
const allow = await allowDaccWallet_V2({
 daccPublickey: 'daccPublickeyV2_0x123_XxX...', // [!code focus]
 passwordSecretkey: 'my+Password#123...'
});
```
...
```ts
const allow = await allowDaccWallet_V2({
 daccPublickey: 'daccPublickeyV2_0x123_XxX...', // [!code --]
